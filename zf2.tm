...
cons().0 0 0 R n_152.0
cons().0 1 1 R cons().1
cons().1 0 0 R pair(scratch2,topwff,scratch1).0
cons().1 1 1 R while_decnz(scratch2,3.topwff.inc).0
cparam().n_103.0 0 0 R cparam().n_103.0.0
cparam().n_103.0 1 0 L 6.break.1
cparam().n_103.0.0 0 0 R 3.axiomcode.decnz
cparam().n_103.0.0 1 1 R cparam().n_103.0.1
cparam().n_103.0.1 0 0 R cparam().n_103.0.1.0
cparam().n_103.0.1 1 1 R cparam().n_103.0.2
cparam().n_103.0.1.0 0 0 R 3.axiomcode.decnz
cparam().n_103.0.1.0 1 1 R cparam().n_103.0.1.1
cparam().n_103.0.1.1 0 0 R cparam().n_103.0.1.1.0
cparam().n_103.0.1.1 1 0 L 6.break.1
cparam().n_103.0.1.1.0 0 0 R 3.axiomcode.inc
cparam().n_103.0.1.1.0 1 1 R 3.axiomcode.inc
cparam().n_103.0.2 0 0 R cparam().n_103.0.2.0
cparam().n_103.0.2 1 0 L 6.break.1
cparam().n_103.0.2.0 0 0 R 3.axiomcode.inc
cparam().n_103.0.2.0 1 1 R n_152.0
cparam(param2).0 0 0 R cparam().n_103.0
...
cparam(param3).0 0 0 R cparam().n_103.0
...
if_eq().n_90.0 0 0 R if_eq().n_90.0.0
if_eq().n_90.0 1 1 R if_eq().n_90.1
if_eq().n_90.0.0 0 0 R 3.scratch2.decnz
if_eq().n_90.0.0 1 1 R if_eq().n_90.0.1
if_eq().n_90.0.1 0 0 R if_eq().n_90.0.1.0
if_eq().n_90.0.1 1 1 R if_eq().n_90.0.2
if_eq().n_90.0.1.0 0 0 R 3.scratch3.decnz
if_eq().n_90.0.1.0 1 0 L 6.continue.1
if_eq().n_90.0.2 0 0 R while_decnz(scratch2,()).0
if_eq().n_90.0.2 1 0 L 6.break.2
if_eq().n_90.1 0 0 R 3.scratch3.decnz
if_eq().n_90.1 1 1 R if_eq().n_90.2
if_eq().n_90.2 0 0 R while_decnz(scratch3,()).0
if_eq().n_90.2 1 0 L 6.break.1
if_eq(scratch2,scratch3,112).0 0 0 R if_eq().n_90.0
if_eq(scratch2,scratch3,112).0 1 1 R if_eq(scratch2,scratch3,112).1
if_eq(scratch2,scratch3,112).1 0 0 R while_decnz(param1,109).0
if_eq(scratch2,scratch3,112).1 1 1 R while_decnz(scratch1,3.param1.inc).0
if_eq(scratch2,scratch3,3.param1.inc).0 0 0 R if_eq().n_90.0
if_eq(scratch2,scratch3,3.param1.inc).0 1 1 R 3.param1.inc
if_eq(scratch2,scratch3,3.param2.inc).0 0 0 R if_eq().n_90.0
if_eq(scratch2,scratch3,3.param2.inc).0 1 1 R 3.param2.inc
if_not_decnz(axiomcode,56).0 0 0 R if_not_decnz(axiomcode,56).0.0
if_not_decnz(axiomcode,56).0 1 1 R if_not_decnz(axiomcode,56).1
if_not_decnz(axiomcode,56).0.0 0 0 R 3.axiomcode.decnz
if_not_decnz(axiomcode,56).0.0 1 0 L 6.break.1
if_not_decnz(axiomcode,56).1 0 0 R while_decnz(topwff,()).0
if_not_decnz(axiomcode,56).1 1 1 R while_decnz(scratch1,3.topwff.inc).0
if_not_decnz(prooflist,66).0 0 0 R if_not_decnz(prooflist,66).0.0
if_not_decnz(prooflist,66).0 1 1 R if_not_decnz(prooflist,66).1
if_not_decnz(prooflist,66).0.0 0 0 R 3.prooflist.decnz
if_not_decnz(prooflist,66).0.0 1 0 L 6.break.1
if_not_decnz(prooflist,66).1 0 0 R while_decnz(nextproof,61).0
if_not_decnz(prooflist,66).1 1 1 R if_not_decnz(prooflist,66).2
if_not_decnz(prooflist,66).2 0 0 R while_decnz(scratch1,3.nextproof.inc).0
if_not_decnz(prooflist,66).2 1 1 R 3.nextproof.inc
main().0 0 0 R if_not_decnz(prooflist,66).0
main().0 1 1 R main().1
main().1 0 0 R while_decnz(axiomcode,()).0
main().1 1 1 R main().2
main().10 0 0 R while_decnz(scratch1,3.param2.inc).0
main().10 1 1 R main().11
main().100 0 0 R main().n_145.0
main().100 1 1 R main().101
main().101 0 0 R main().n_134.0
main().101 1 1 R main().102
main().102 0 0 R main().n_145.0
main().102 1 1 R main().103
main().103 0 0 R cparam(param3).0
main().103 1 1 R main().104
main().104 0 0 R main().n_148.0
main().104 1 1 R main().105
main().105 0 0 R wim().0
main().105 1 1 R main().106
main().106 0 0 R while_decnz(topwff,3.scratch2.inc).0
main().106 1 1 R main().107
main().107 0 0 R n_146.0
main().107 1 1 R main().108
main().108 0 0 R if_eq(scratch2,scratch3,112).0
main().108 1 1 R main().109
main().109 0 0 R select().0
main().109 1 1 R main().110
main().11 0 0 R main().n_137.0
main().11 1 1 R main().12
main().110 0 0 R 3.topwff.decnz
main().110 1 1 R main().111
main().111 0 0 R main().111.0
main().111 1 1 R halt
main().111.0 0 0 R 3.topwff.decnz
main().111.0 1 1 R main().111.1
main().111.1 0 0 R main().111.1.0
main().111.1 1 0 L 6.break.1
main().111.1.0 0 0 R 3.topwff.inc
main().111.1.0 1 1 R 3.topwff.inc
main().12 0 0 R while_decnz(scratch1,3.param3.inc).0
main().12 1 1 R main().13
main().13 0 0 R main().n_140.0
main().13 1 1 R main().14
main().14 0 0 R wim().0
main().14 1 1 R main().15
main().15 0 0 R par2().0
main().15 1 1 R main().16
main().16 0 0 R main().n_138.0
main().16 1 1 R main().17
main().17 0 0 R par1().0
main().17 1 1 R main().18
main().18 0 0 R main().n_138.0
main().18 1 1 R main().19
main().19 0 0 R wim().0
main().19 1 1 R main().20
main().2 0 0 R while_decnz(param1,()).0
main().2 1 1 R main().3
main().20 0 0 R main().n_139.0
main().20 1 1 R main().21
main().21 0 0 R par1().0
main().21 1 1 R main().22
main().22 0 0 R wn().0
main().22 1 1 R main().23
main().23 0 0 R par2().0
main().23 1 1 R main().24
main().24 0 0 R main().n_130.0
main().24 1 1 R main().25
main().25 0 0 R wn().0
main().25 1 1 R main().26
main().26 0 0 R par1().0
main().26 1 1 R main().27
main().27 0 0 R main().n_139.0
main().27 1 1 R main().28
main().28 0 0 R main().n_123.0
main().28 1 1 R main().29
main().29 0 0 R main().n_142.0
main().29 1 1 R main().30
main().3 0 0 R while_decnz(param2,()).0
main().3 1 1 R main().4
main().30 0 0 R main().n_134.0
main().30 1 1 R main().31
main().31 0 0 R main().n_132.0
main().31 1 1 R main().32
main().32 0 0 R wim().0
main().32 1 1 R main().33
main().33 0 0 R main().n_123.0
main().33 1 1 R main().34
main().34 0 0 R wal().0
main().34 1 1 R main().35
main().35 0 0 R wal().0
main().35 1 1 R main().36
main().36 0 0 R par2().0
main().36 1 1 R main().37
main().37 0 0 R main().n_132.0
main().37 1 1 R main().38
main().38 0 0 R main().n_121.0
main().38 1 1 R main().39
main().39 0 0 R wel().0
main().39 1 1 R main().40
main().4 0 0 R while_decnz(param3,()).0
main().4 1 1 R main().5
main().40 0 0 R main().n_141.0
main().40 1 1 R main().41
main().41 0 0 R main().n_122.0
main().41 1 1 R main().42
main().42 0 0 R main().n_143.0
main().42 1 1 R main().43
main().43 0 0 R main().n_140.0
main().43 1 1 R main().44
main().44 0 0 R main().n_121.0
main().44 1 1 R main().45
main().45 0 0 R weq().0
main().45 1 1 R main().46
main().46 0 0 R main().n_141.0
main().46 1 1 R main().47
main().47 0 0 R weq().0
main().47 1 1 R main().48
main().48 0 0 R main().n_136.0
main().48 1 1 R main().49
main().49 0 0 R main().n_124.0
main().49 1 1 R main().50
main().5 0 0 R main().n_137.0
main().5 1 1 R main().6
main().50 0 0 R main().n_133.0
main().50 1 1 R main().51
main().51 0 0 R main().n_122.0
main().51 1 1 R main().52
main().52 0 0 R weq().0
main().52 1 1 R main().53
main().53 0 0 R main().n_129.0
main().53 1 1 R main().54
main().54 0 0 R par2().0
main().54 1 1 R main().55
main().55 0 0 R main().n_141.0
main().55 1 1 R main().56
main().56 0 0 R main().n_126.0
main().56 1 1 R main().57
main().57 0 0 R main().n_142.0
main().57 1 1 R main().58
main().58 0 0 R main().n_120.0
main().58 1 1 R main().59
main().59 0 0 R main().n_141.0
main().59 1 1 R main().60
main().6 0 0 R while_decnz(scratch1,3.axiomcode.inc).0
main().6 1 1 R main().7
main().60 0 0 R par2().0
main().60 1 1 R main().61
main().61 0 0 R main().n_126.0
main().61 1 1 R main().62
main().62 0 0 R main().n_144.0
main().62 1 1 R main().63
main().63 0 0 R main().n_120.0
main().63 1 1 R main().64
main().64 0 0 R main().n_147.0
main().64 1 1 R main().65
main().65 0 0 R wel().0
main().65 1 1 R main().66
main().66 0 0 R main().n_140.0
main().66 1 1 R main().67
main().67 0 0 R par1().0
main().67 1 1 R main().68
main().68 0 0 R main().n_143.0
main().68 1 1 R main().69
main().69 0 0 R main().n_128.0
main().69 1 1 R main().70
main().7 0 0 R main().n_137.0
main().7 1 1 R main().8
main().70 0 0 R wim().0
main().70 1 1 R main().71
main().71 0 0 R main().n_127.0
main().71 1 1 R main().72
main().72 0 0 R par1().0
...
main().n_120.0 0 0 R main().n_128.0
main().n_120.0 1 1 R main().n_120.1
main().n_120.1 0 0 R wal().0
main().n_120.1 1 1 R main().n_129.0
main().n_121.0 0 0 R main().n_125.0
main().n_121.0 1 1 R main().n_121.1
main().n_121.1 0 0 R weq().0
main().n_121.1 1 1 R main().n_150.0
main().n_122.0 0 0 R wel().0
main().n_122.0 1 1 R main().n_122.1
main().n_122.1 0 0 R main().n_130.0
main().n_122.1 1 1 R main().n_140.0
main().n_123.0 0 0 R main().n_131.0
main().n_123.0 1 1 R par3().0
main().n_124.0 0 0 R main().n_140.0
main().n_124.0 1 1 R main().n_124.1
main().n_124.1 0 0 R weq().0
main().n_124.1 1 1 R main().n_147.0
main().n_125.0 0 0 R wal().0
main().n_125.0 1 1 R main().n_131.0
main().n_126.0 0 0 R wel().0
main().n_126.0 1 1 R main().n_126.1
main().n_126.1 0 0 R main().n_148.0
main().n_126.1 1 1 R wel().0
main().n_127.0 0 0 R main().n_135.0
main().n_127.0 1 1 R par1().0
main().n_128.0 0 0 R main().n_135.0
main().n_128.0 1 1 R wim().0
main().n_129.0 0 0 R wex().0
main().n_129.0 1 1 R main().n_129.1
main().n_129.1 0 0 R select().0
main().n_129.1 1 1 R main().n_141.0
main().n_130.0 0 0 R main().n_136.0
main().n_130.0 1 1 R par1().0
main().n_131.0 0 0 R main().n_149.0
main().n_131.0 1 1 R main().n_140.0
main().n_132.0 0 0 R main().n_150.0
main().n_132.0 1 1 R wal().0
main().n_133.0 0 0 R main().n_151.0
main().n_133.0 1 1 R par2().0
main().n_134.0 0 0 R main().n_140.0
main().n_134.0 1 1 R wal().0
main().n_135.0 0 0 R par3().0
main().n_135.0 1 1 R main().n_135.1
main().n_135.1 0 0 R par2().0
main().n_135.1 1 1 R wel().0
main().n_136.0 0 0 R wim().0
main().n_136.0 1 1 R main().n_149.0
main().n_137.0 0 0 R unpair(scratch1,scratch2,prooflist).0
main().n_137.0 1 1 R while_decnz(scratch2,3.prooflist.inc).0
main().n_138.0 0 0 R par3().0
main().n_138.0 1 1 R wim().0
main().n_139.0 0 0 R wim().0
main().n_139.0 1 1 R par1().0
main().n_140.0 0 0 R par1().0
main().n_140.0 1 1 R par2().0
main().n_141.0 0 0 R par2().0
main().n_141.0 1 1 R par3().0
main().n_142.0 0 0 R wim().0
main().n_142.0 1 1 R wal().0
main().n_143.0 0 0 R wal().0
main().n_143.0 1 1 R wex().0
main().n_144.0 0 0 R wa().0
main().n_144.0 1 1 R wex().0
main().n_145.0 0 0 R select().0
main().n_145.0 1 1 R cparam(param2).0
main().n_147.0 0 0 R par3().0
main().n_147.0 1 1 R par1().0
main().n_148.0 0 0 R par2().0
main().n_148.0 1 1 R par1().0
main().n_149.0 0 0 R wim().0
main().n_149.0 1 1 R select().0
main().n_150.0 0 0 R par1().0
main().n_150.0 1 1 R par3().0
main().n_151.0 0 0 R wel().0
main().n_151.0 1 1 R par3().0
n_146.0 0 0 R while_decnz(param3,79).0
n_146.0 1 1 R while_decnz(scratch1,3.param3.inc).0
n_152.0 0 0 R unpair(scratch1,scratch2,wffstack).0
n_152.0 1 1 R while_decnz(scratch2,3.wffstack.inc).0
pair(scratch1,topwff,wffstack).0 0 0 R while_decnz(topwff,20).0
...
pair(scratch2,topwff,scratch1).0 0 0 R while_decnz(topwff,9).0
pair(scratch2,topwff,scratch1).0 1 1 R pair(scratch2,topwff,scratch1).1
pair(scratch2,topwff,scratch1).1 0 0 R 3.scratch1.decnz
pair(scratch2,topwff,scratch1).1 1 1 R pair(scratch2,topwff,scratch1).2
pair(scratch2,topwff,scratch1).2 0 0 R pair(scratch2,topwff,scratch1).2.0
pair(scratch2,topwff,scratch1).2 1 0 L 6.continue.2
pair(scratch2,topwff,scratch1).2.0 0 0 R 3.scratch2.inc
pair(scratch2,topwff,scratch1).2.0 1 1 R while_decnz(scratch1,3.topwff.inc).0
par1().0 0 0 R pushwff().0
par1().0 1 1 R par1().1
par1().1 0 0 R while_decnz(param1,41).0
par1().1 1 1 R while_decnz(scratch1,3.param1.inc).0
par2().0 0 0 R pushwff().0
par2().0 1 1 R par2().1
par2().1 0 0 R while_decnz(param2,41).0
par2().1 1 1 R while_decnz(scratch1,3.param2.inc).0
par3().0 0 0 R pushwff().0
par3().0 1 1 R par3().1
par3().1 0 0 R while_decnz(param3,41).0
...
safety(param1,param3).0 0 0 R while_decnz(param1,9).0
safety(param1,param3).0 1 1 R safety(param1,param3).1
safety(param1,param3).1 0 0 R while_decnz(scratch1,3.param1.inc).0
safety(param1,param3).1 1 1 R safety(param1,param3).2
safety(param1,param3).2 0 0 R n_146.0
safety(param1,param3).2 1 1 R if_eq(scratch2,scratch3,3.param1.inc).0
safety(param2,param3).0 0 0 R while_decnz(param2,9).0
safety(param2,param3).0 1 1 R safety(param2,param3).1
safety(param2,param3).1 0 0 R while_decnz(scratch1,3.param2.inc).0
safety(param2,param3).1 1 1 R safety(param2,param3).2
safety(param2,param3).2 0 0 R n_146.0
safety(param2,param3).2 1 1 R if_eq(scratch2,scratch3,3.param2.inc).0
select().0 0 0 R n_152.0
select().0 1 1 R select().1
select().1 0 0 R if_not_decnz(axiomcode,56).0
select().1 1 1 R while_decnz(scratch1,()).0
unpair().n_5.0 0 0 R 3.scratch1.inc
unpair().n_5.0 1 1 R unpair().n_5.1
unpair().n_5.1 0 0 R unpair().n_5.1.0
unpair().n_5.1 1 1 R unpair().n_5.2
unpair().n_5.1.0 0 0 R 3.scratch2.decnz
unpair().n_5.1.0 1 0 L 6.continue.2
...
while_decnz().n_10.0 0 0 R while_decnz().n_10.0.0
while_decnz().n_10.0 1 0 L 6.continue.1
while_decnz().n_10.0.0 0 0 R 3.scratch1.inc
while_decnz().n_10.0.0 1 1 R 3.scratch2.inc
while_decnz().n_12.0 0 0 R 3.topwff.inc
while_decnz().n_12.0 1 0 L 6.continue.1
while_decnz().n_42.0 0 0 R while_decnz().n_42.0.0
while_decnz().n_42.0 1 0 L 6.continue.1
while_decnz().n_42.0.0 0 0 R 3.topwff.inc
while_decnz().n_42.0.0 1 1 R 3.scratch1.inc
...
while_decnz(nextproof,61).0 0 0 R 3.nextproof.decnz
while_decnz(nextproof,61).0 1 1 R while_decnz(nextproof,61).1
while_decnz(nextproof,61).1 0 0 R while_decnz(nextproof,61).1.0
while_decnz(nextproof,61).1 1 0 L 6.continue.1
while_decnz(nextproof,61).1.0 0 0 R 3.scratch1.inc
while_decnz(nextproof,61).1.0 1 1 R 3.prooflist.inc
while_decnz(param1,()).0 0 0 R 3.param1.decnz
while_decnz(param1,()).0 1 0 L 6.continue.0
while_decnz(param1,109).0 0 0 R 3.param1.decnz
while_decnz(param1,109).0 1 1 R while_decnz(param1,109).1
while_decnz(param1,109).1 0 0 R while_decnz(param1,109).1.0
while_decnz(param1,109).1 1 0 L 6.continue.1
while_decnz(param1,109).1.0 0 0 R 3.scratch1.inc
while_decnz(param1,109).1.0 1 1 R 3.topwff.inc
while_decnz(param1,41).0 0 0 R 3.param1.decnz
while_decnz(param1,41).0 1 1 R while_decnz().n_42.0
while_decnz(param1,9).0 0 0 R 3.param1.decnz
while_decnz(param1,9).0 1 1 R while_decnz().n_10.0
while_decnz(param2,()).0 0 0 R 3.param2.decnz
while_decnz(param2,()).0 1 0 L 6.continue.0
while_decnz(param2,41).0 0 0 R 3.param2.decnz
while_decnz(param2,41).0 1 1 R while_decnz().n_42.0
while_decnz(param2,9).0 0 0 R 3.param2.decnz
while_decnz(param2,9).0 1 1 R while_decnz().n_10.0
while_decnz(param3,()).0 0 0 R 3.param3.decnz
while_decnz(param3,()).0 1 0 L 6.continue.0
while_decnz(param3,41).0 0 0 R 3.param3.decnz
while_decnz(param3,41).0 1 1 R while_decnz().n_42.0
while_decnz(param3,79).0 0 0 R 3.param3.decnz
while_decnz(param3,79).0 1 1 R while_decnz(param3,79).1
while_decnz(param3,79).1 0 0 R while_decnz(param3,79).1.0
while_decnz(param3,79).1 1 0 L 6.continue.1
while_decnz(param3,79).1.0 0 0 R 3.scratch1.inc
while_decnz(param3,79).1.0 1 1 R 3.scratch3.inc
...
while_decnz(scratch1,3.topwff.inc).0 1 1 R while_decnz().n_12.0
...
while_decnz(scratch2,3.topwff.inc).0 1 1 R while_decnz().n_12.0
...
while_decnz(topwff,20).0 0 0 R 3.topwff.decnz
while_decnz(topwff,20).0 1 1 R while_decnz(topwff,20).1
while_decnz(topwff,20).1 0 0 R while_decnz(topwff,20).1.0
while_decnz(topwff,20).1 1 0 L 6.continue.1
while_decnz(topwff,20).1.0 0 0 R 3.wffstack.inc
while_decnz(topwff,20).1.0 1 1 R 3.scratch1.inc
while_decnz(topwff,3.scratch2.inc).0 0 0 R 3.topwff.decnz
while_decnz(topwff,3.scratch2.inc).0 1 1 R while_decnz().n_0.0
while_decnz(topwff,9).0 0 0 R 3.topwff.decnz
while_decnz(topwff,9).0 1 1 R while_decnz().n_10.0
while_decnz(wffstack,3.topwff.inc).0 0 0 R 3.wffstack.decnz
while_decnz(wffstack,3.topwff.inc).0 1 1 R while_decnz().n_12.0
wim().0 0 0 R cons().0
wim().0 1 1 R wim().1
wim().1 0 0 R v_2().0
wim().1 1 1 R cons().0
